...
6. Save, then wait a minute or two for GitHub to publish the site.

## Run Locally

Open `index.html` in a browser.

No install step is required. The site is built with plain HTML, CSS, and JavaScript.

## Features

- Interactive 8x8 chessboard
- Random coordinate prompts
